...
<div class="page-content">
  ...
  <div class="card">
    ...
    @endforeach
      ...
      <hr />
      <form id="myForm" method="post" action="{{ route('vendor.store.product') }}" enctype="multipart/form-data"> @csrf 
      <div class="form-body mt-4">
        <div class="row">
              ...
              <div class="border border-3 p-4 rounded">
                ...
                <div class="form-group mb-3">
                  <label for="mytextarea" class="form-label">Short Description</label>
                  <textarea name="short_desc" class="form-control" rows="3" id="mytextarea"></textarea>
                </div>
                <div class="form-group mb-3">
                  <label for="inputProductDescription" class="form-label">Long Description</label>
                  <textarea name="long_desc" id="inputProductDescription">Hello, World!</textarea>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="row g-3">
                  ...
                  <div class="form-group col-12">
                    ...
                    <select name="brand_id" class="form-select" id="inputProductType">
                      <option>--Select Brand--</option> @foreach($brands as $item) <option value="{{ $item->id }}">{{ $item->brand_name }}</option> @endforeach
                    </select>
                  </div>
                  <div class="form-group col-12">
                  ...
                  <div class="form-group col-12">
                    ...
                    <select name="vendor_id" class="form-select" id="inputCollection">
                      <option>--Select Vendor--</option> @foreach($vendors as $item) <option value="{{ $item->id }}">{{ $item->username }}</option> @endforeach
                    </select>
                  </div>
                  <div class="form-group col-12">
                    <div class="row g-3">
