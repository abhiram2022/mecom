...
<form id="myForm" method="post" action="{{ route('update.product') }}" enctype="multipart/form-data" >
           ...
           <div class="border border-3 p-4 rounded">
            ...
            <div class="mb-3">
			  ...
			  <div class="form-group mb-3">
				...
				<textarea name="short_desc" class="form-control" >{{ $products->short_desc }}</textarea>
			  </div>

			   <div class="mb-3">
				<label for="long_desc" class="form-label">Long Description</label>
				<textarea id="inputProductDescription" rows="3"name="long_desc" >
				...
				<div class="form-group col-md-6">
				  ...
				  <div class="form-group col-12">
					...
					<select name="category_id" class="form-select" id="inputVendor">
						...
						<option value="{{ $cat->id }}" 
							{{ $cat->id == $products->caterogy_id ? 'selected' : '' }}
 ...
 <input class="form-check-input" name="hot_deals" type="checkbox" {{ $products->hot_deals == 1 ? 'selected' : '' }} value="1" id="flexCheckDefault">
	...
	<div class="col-md-6">	
    <div class="form-check">
			<input class="form-check-input" name="featured" {{ $products->featured == 1 ? 'selected' : '' }}  type="checkbox" value="1" id="flexCheckDefault">
...
<div class="col-md-6">	
    <div class="form-check">
			<input class="form-check-input" name="special_offer" {{ $products->special_offer == 1 ? 'selected' : '' }} type="checkbox" value="1" id="flexCheckDefault">
	...
	<div class="col-md-6">	
    <div class="form-check">
			<input class="form-check-input" name="special_deals" type="checkbox" {{ $products->special_deals == 1 ? 'selected' : '' }}value="1" id="flexCheckDefault">
...
<div class="page-content">
	<h6 class="mb-0 text-uppercase">Update Thamb Image </h6>
	<hr>
<div class="card">
<form method="post" id="ThambImgUpload" action="{{route('update.thambnail')}}" enctype="multipart/form-data" >
	@csrf
<div class="card-body">
	<div class="form-group mb-3">
                  <label for="formFile" class="form-label">Choose Thambnail Image</label>
                  <input name="product_thambnail" type="file" class="form-control mb-2"id="formFile" onChange="mainThamUrl(this)">
	...
	<div class="form-group mb-3">
		...
		<label for="formFile" class="form-label"></label>
		             <img src="{{asset($products->product_thambnail)}}" id="mainThmb" style="width:100px;height:100px"/>
	</div>
