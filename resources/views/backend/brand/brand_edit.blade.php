								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control"  name="brand_slug" value="{{$brand->brand_slug}}" disabled />
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<img id="showImage" src="{{(!empty($brand->brand_image))? url($brand->brand_image):url('upload/no_image.jpg')}}" alt="Admin"  width="110" height="100">
											</div>
										</div>
