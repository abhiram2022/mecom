        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Register <span></span> My Account
                </div>
            </div>
        </div>
        <div class="page-content pt-150 pb-150">
            <div class="container">
                ...
                <form method="POST" action="{{route('register') }}">
                   ...
                   <div class="form-group">
                        <input required="" type="password" name="password_confirmation" id="password_confirmation" placeholder="Conformation Password" />
                    </div>
