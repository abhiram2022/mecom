                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    @auth
                                    <a href="page-account.html"><span class="lable ml-0"> {{Auth::user()->username}}</span></a>
                                    ...
                                    <ul>
                                     ...
                                     @else
                                        <a href="#"><span class="lable ml-0">Login/Signup</span></a>
                                        <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                             <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{route('user.change.password')}}">Register</a></li>
